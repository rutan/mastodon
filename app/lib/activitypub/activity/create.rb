...
class ActivityPub::Activity::Create < ActivityPub::Activity
  ...
  def process_status_params
    ...
    @params = {
      ...
      media_attachment_ids: process_attachments.take(MediaAttachment::MAX_UPLOAD_SIZE).map(&:id),
      poll: process_poll,
    }
  end
  ...
  def process_attachments
    ...
    as_array(@object['attachment']).each do |attachment|
      ...
      next if media_attachment_parser.remote_url.blank? || media_attachments.size >= MediaAttachment::MAX_UPLOAD_SIZE
